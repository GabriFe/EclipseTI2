...
public class ProdutoService {
	...
	public void makeForm(int tipo, Usuario produto, int orderBy) {
		...
		if(tipo != FORM_INSERT) {
			...
			umUsuario += "\t\t<tr>";
			umUsuario += "\t\t\t<td align=\"left\"><font size=\"+2\"><b>&nbsp;&nbsp;&nbsp;<a href=\"/produto/list/1\">Novo Produto</a></b></font></td>";
			umUsuario += "\t\t</tr>";
			umUsuario += "\t</table>";
			umUsuario += "\t<br>";			
		}
		...
		if(tipo == FORM_INSERT || tipo == FORM_UPDATE) {
			...
			umUsuario += "\t\t</tr>";
			umUsuario += "\t\t<tr>";
			umUsuario += "\t\t\t<td>&nbsp;Descrição: <input class=\"input--register\" type=\"text\" name=\"login\" value=\""+ login +"\"></td>";
			umUsuario += "\t\t\t<td>Preco: <input class=\"input--register\" type=\"text\" name=\"senha\" value=\""+ usuario.getSenha() +"\"></td>";
			umUsuario += "\t\t\t<td>Quantidade: <input class=\"input--register\" type=\"text\" name=\"nome\" value=\""+ usuairo.getNome() +"\"></td>";
			umUsuario += "\t\t</tr>";
			umUsuario += "\t\t<tr>";
			...
			umUsuario += "\t<table width=\"80%\" bgcolor=\"#f3f3f3\" align=\"center\">";
			umUsuario += "\t\t<tr>";
			umUsuario += "\t\t\t<td colspan=\"3\" align=\"left\"><font size=\"+2\"><b>&nbsp;&nbsp;&nbsp;Detalhar Produto (ID " + produto.getID() + ")</b></font></td>";
			umUsuario += "\t\t</tr>";
			umUsuario += "\t\t<tr>";
			umUsuario += "\t\t\t<td colspan=\"3\" align=\"left\">&nbsp;</td>";
			umUsuario += "\t\t</tr>";
	...
	public Object update(Request request, Response response) {
        ...
        if (usuario != null) {
        	usuario.setDescricao(request.queryParams("login"));
        	usuario.setPreco(request.queryParams("senha"));
        	usuario.setQuantidade(request.queryParams("nome"));
        	usuario.setDataFabricacao(request.queryParams("email"));
